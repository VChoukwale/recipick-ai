...
- FLAVOR PROFILE VARIETY (important): When count >= 4, ensure at least one recipe from EACH of these zones — (1) comforting/mild/earthy, (2) bold/spicy/tangy, (3) fresh/light/bright. Do NOT give all savory-heavy or all spicy results. If count >= 5, add a 4th distinct flavor profile (e.g. sweet-savory, umami-rich, or fermented/complex). This creates a natural "mix-n-match" feel even within a single cuisine filter.
