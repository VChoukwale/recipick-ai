...
export default function AddItemSheet({ onAdd, onClose, suggestions }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-charcoal-900 rounded-t-3xl shadow-2xl max-w-lg mx-auto animate-slide-up max-h-[90vh] overflow-y-auto">
