  ...
  return (
    <>
      ...
      <button
        ...
        className="absolute bottom-20 right-3 z-20 w-12 h-12 rounded-full flex items-center justify-center shadow-lg active:scale-95 transition-all duration-150"
        style={{ background: 'linear-gradient(135deg, #E8713A, #D85F22)', boxShadow: '0 4px 16px rgba(232,113,58,0.45)' }}
        title="Ask the cooking assistant"
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 pt-2 pb-3 flex-shrink-0" style={{ borderBottom: '1px solid var(--bdr-s)' }}>
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="font-display font-700 text-base leading-tight" style={{ color: 'var(--t1)' }}>Chef Kai</p>
                  <p className="text-[11px] font-body" style={{ color: 'var(--t3)' }}>Your cooking buddy</p>
                </div>
              </div>
              <button
                  ...
                  <div className="flex gap-2.5">
                    ...
                    <div className="rounded-2xl rounded-tl-sm px-3.5 py-2.5 max-w-[85%]"
                      ...
                      <p className="text-sm font-body leading-relaxed" style={{ color: 'var(--t1)' }}>
                        Hey! I'm Kai 👋 Ask me anything about cooking — techniques, ingredients, substitutions, storage tips, or anything food-related!
                      </p>
                    </div>
                  </div>
